    ...
    <div className="large-frame">
      <div className="large-header">
        <div className="flex items-center gap-3">
          <span className="text-gold-bright font-cinzel-decorative text-sm tracking-[4px] uppercase text-glow-gold">☠️ Cursed Assistant</span>
          <div className="flex items-center gap-2 ml-4">
            <span className={cn('status-dot text-[9px]', connections.owlbear ? 'status-online' : 'status-offline')}>OBR {connections.owlbear ? '●' : '○'}</span>
